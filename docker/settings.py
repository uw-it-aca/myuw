...
LOGGING = {
    ...
    'handlers': {
        ...
        'myuw': {
            ...
            'filename': '/app/myuw/logs/myuw.log',
            'formatter': 'myuw',
        },
        'pref': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/pref',
            'formatter': 'myuw',
        },
        'card': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/card.log',
            'formatter': 'myuw',
        },
        'link': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/link.log',
            'formatter': 'myuw',
        },
        'notice': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/notice.log',
            'formatter': 'myuw',
        },
        'session': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/session.log',
            'formatter': 'myuw',
        },
        'performance': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/view_performance.log',
            'formatter': 'myuw',
        },
        'restclients_timing_log': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/app/myuw/logs/restclients_timing.log',
            'formatter': 'myuw',
        },
