...
RESTCLIENTS_BOOK_TIMEOUT = 10
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_BOOK_POOL_SIZE = 50
else:
    RESTCLIENTS_BOOK_POOL_SIZE = 10

RESTCLIENTS_CALENDAR_TIMEOUT = 5
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_CALENDAR_POOL_SIZE = 30
else:
...
RESTCLIENTS_GRADEPAGE_POOL_SIZE = 10

RESTCLIENTS_IASYSTEM_UW_TIMEOUT = 5
RESTCLIENTS_IASYSTEM_UW_POOL_SIZE = 20
...
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_LIBCURRICS_POOL_SIZE = 20
else:
...
RESTCLIENTS_MAILMAN_TIMEOUT = 30
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_MAILMAN_POOL_SIZE = 20
else:
    RESTCLIENTS_MAILMAN_POOL_SIZE = 5

RESTCLIENTS_MYPLAN_TIMEOUT = 5
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_MYPLAN_POOL_SIZE = 20
else:
    RESTCLIENTS_MYPLAN_POOL_SIZE = 10

RESTCLIENTS_PWS_TIMEOUT=5
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_PWS_POOL_SIZE = 50
else:
    RESTCLIENTS_PWS_POOL_SIZE = 15

RESTCLIENTS_SWS_TIMEOUT = 5
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_SWS_POOL_SIZE = 50
else:
    RESTCLIENTS_SWS_POOL_SIZE = 15

if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_UPASS_TIMEOUT = 10
    RESTCLIENTS_UPASS_POOL_SIZE = 20
else:
...
if os.getenv("ENV", "") == "prod":
    RESTCLIENTS_UWNETID_POOL_SIZE = 50
else:
