...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'myuw_mobile', ['CourseColor'])
        ...
        db.send_create_signal(u'myuw_mobile', ['User'])
        ...
        db.send_create_signal(u'myuw_mobile', ['Building'])
        ...
        db.send_create_signal(u'myuw_mobile', ['StudentAccountsBalances'])
        ...
        db.send_create_signal(u'myuw_mobile', ['UserNotices'])
        ...
        db.send_create_signal(u'myuw_mobile', ['CategoryLinks'])
        ...
        db.send_create_signal(u'myuw_mobile', ['TuitionDate'])
