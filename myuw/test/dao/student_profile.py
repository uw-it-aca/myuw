...
from myuw.dao.student_profile import _get_minors_for_terms,\
                                    _get_majors_for_terms
...
class TestStudentProfile(TestCase):
    def test_get_majors_for_terms(self):
        ...
        majors = _get_majors_for_terms(terms, enrollments)
    ...
    def test_get_minors_for_terms(self):
        ...
        minors = _get_minors_for_terms(terms, enrollments)
