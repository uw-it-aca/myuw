...
import { faExclamationTriangle, faLocationArrow } from '@fortawesome/free-solid-svg-icons';
...
describe('Events Card', () => {
  ...
  it('acalDateFormat', () => {
    ...
    expect(wrapper.vm.acalDateFormat(dayjs('2020-08-19'), dayjs('2020-08-19'))).toEqual(
      'August 19'
    );
    expect(wrapper.vm.acalDateFormat(dayjs('2020-08-19'), dayjs('2020-08-20'))).toEqual(
      'August 19 - 20'
    );
  });
