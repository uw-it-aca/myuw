...
describe('Events Card', () => {
  ...
  it('toFriendlyDate', () => {
    ...
    expect(wrapper.vm.toFriendlyDate('2020-08-24')).toEqual('Mon, Aug 24');

    expect(wrapper.vm.toFriendlyDate(undefined)).toEqual('');
    expect(wrapper.vm.toFriendlyDate('')).toEqual('');
  });
});
