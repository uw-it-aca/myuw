...
describe('Quicklinks/Link', () => {
  ...
  it('Custom remove link', async () => {
    ...
    wrapper
      .findAllComponents(Link)
      .at(mockQuicklinksCopy['default_links'].length + removeLinkIndex)
      .findAll('button')
      .at(1)
      .trigger('click');
  ...
  it('Custom edit link', async () => {
    ...
    wrapper
      .findAllComponents(Link)
      .at(mockQuicklinksCopy['default_links'].length + editLinkIndex)
  ...
  it('recent save link', async () => {
    ...
    const newLinkIndex =
      mockQuicklinksCopy.recent_links.push({
        ...newRecentLink,
      }) - 1;
    ...
    wrapper
      .findAllComponents(Link)
      .at(mockQuicklinksCopy['default_links'].length + newLinkIndex)
