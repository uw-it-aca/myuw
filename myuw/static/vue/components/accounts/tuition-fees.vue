<template>
  ...
  >
    ...
    <template #card-body>
      ...
      >
        <template #status>
          <a href="https://sdb.admin.uw.edu/sisStudents/uwnetid/finaidstatus.aspx" target="_blank" data-linklabel="Financial Aid Status" class="myuw-text-md">Financial Aid Status</a>
        </template>
      </uw-fin-aid>
