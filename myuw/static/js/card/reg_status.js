var RegStatusCard = {
    ...
    _render_for_term: function(myplan_data, quarter, summer_card_label) {
        ...
        var notice_my_reg_is_open = false;
        ...
        for (i = 0; i < est_reg_date_notices.length; i++) {
            ...
            for (j = 0; j < notice.attributes.length; j++) {
                ...
                if ((is_summer_reg &&
                    ...
                    notice_my_reg_is_open = notice.my_reg_has_opened;
        ...
        var template_data = {
            ...
            "registration_is_open": (notice_my_reg_is_open || (!has_est_reg_date_notice && window.card_display_dates.reg_period1_started)),
            ...
            "is_c2": window.user.grad_c2 || window.user.undergrad_c2,
