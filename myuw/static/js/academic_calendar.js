var AcademicCalendar = {
    show_events: function() {
        ...
        WebServiceData.require({academic_cal_event_data: new AcademicCalendarEventData()}, AcademicCalendar.render_events);
    },

    render_events: function(resources) {
        "use strict";
        var events = resources.academic_cal_event_data.data;
